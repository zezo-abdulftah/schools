            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    <a class="button x-small" href="#" data-toggle="modal" data-target="#exampleModal">
                        {{ trans('Supervisor_trans.add_section') }}</a>
                </div>
                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($supervisors as $supervisor)
                                                                    <tr>
                                                                        <?php $i++; ?>
                                                                        <td>{{ $i }}</td>
                                                                        <td>{{ $supervisor->class->Name_Class }}</td>
                                                                        <td>{{ $supervisor->teacher->Name }}
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="#"
                                                                               ...
                                                                               data-toggle="modal"
                                                                               data-target="#edit{{ $supervisor->id }}">{{ trans('Sections_trans.Edit') }}</a>
                                                                            <a href="#"
                                                                               class="btn btn-outline-danger btn-sm"
                                                                               data-toggle="modal"
                                                                               data-target="#delete{{ $supervisor->id }}">{{ trans('Sections_trans.Delete') }}</a>
                                                                        </td>
                                                                    </tr>
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $supervisor->getTranslation('Name_Section', 'ar') }}">
                                                                                            </div>
                                                                                            ...
                                                                                            <div class="col">
                                                                                                <input type="text"
                                                                                                       ...
                                                                                                       class="form-control"
                                                                                                       value="{{ $supervisor->getTranslation('Name_Section', 'en') }}">
                                                                                                <input id="id"
                                                                                                       type="hidden"
                                                                                                       name="id"
                                                                                                       class="form-control"
